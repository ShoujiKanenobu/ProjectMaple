...
using UnityEngine;
using static Generation.SimpleVisualizer;
...
namespace Generation
{
    public class Visualizer : MonoBehaviour
    {
        ...
        [SerializeField]
        private int LengthSubtraction = 2;
        [SerializeField]
        ...
        public void CreateNewLevel()
        {
            ...
            roadHelper.transform.localScale = new Vector3(1, 1, 1);
            VisualizeSequence(sequence);
            roadHelper.transform.localScale = new Vector3(5, 5, 5);
        }
